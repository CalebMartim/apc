...
// Usa um for loop para criar as n estrelas cheias e as 10-n estrelas 
...
void nota(int n){
    string estrelas = "";
    string outrasEstrelas = "";
    for(int i = 0; i < n; i++) estrelas += "★";
    for(int i = 0; i < 10-n; i++) outrasEstrelas += "☆";
    cout << "|" << estrelas << outrasEstrelas << "|\n";
}
